...
export default function CouponPage({ coupons }: Props) {
  ...
  const availableCoupons = isMounted ? coupons.filter((coupon) => !isCouponDownloaded(coupon.id)) : [];
  ...
  return (
    <div className='space-y-4'>
      <h2 className='text-lg font-bold'>사용 가능한 쿠폰 {availableCoupons.length}장</h2>
